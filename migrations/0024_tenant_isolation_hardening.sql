...
BEGIN SELECT RAISE(ABORT, 'TENANT_BOUNDARY: client visit code'); END;
...
BEGIN SELECT RAISE(ABORT, 'TENANT_BOUNDARY: care visit'); END;
...
BEGIN SELECT RAISE(ABORT, 'TENANT_BOUNDARY: visit event'); END;
...
BEGIN SELECT RAISE(ABORT, 'TENANT_BOUNDARY: operations task'); END;
...
BEGIN SELECT RAISE(ABORT, 'TENANT_BOUNDARY: operations incident'); END;
...
BEGIN SELECT RAISE(ABORT, 'TENANT_BOUNDARY: care plan'); END;
...
BEGIN SELECT RAISE(ABORT, 'TENANT_BOUNDARY: risk assessment'); END;
...
BEGIN SELECT RAISE(ABORT, 'TENANT_BOUNDARY: client document'); END;
