/** CoreCare Enterprise 1.8.1 — Scheduling Board Polish */
const VERSION = "1.8.1";
...
export default {
  async fetch(request, env) {
    ...
    try {
      ...
      if (url.pathname === "/api/version") return json({ name: "CoreCare", version: VERSION, release: "CoreCare Enterprise 1.8.1 — Scheduling Board Polish" });
