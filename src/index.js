/** CoreCare Enterprise 1.7.0 — Visual Scheduling Board */
const VERSION = "1.7.0";
...
export default {
  async fetch(request, env) {
    ...
    try {
      ...
      if (url.pathname === "/api/version") return json({ name: "CoreCare", version: VERSION, release: "CoreCare Enterprise 1.7.0 — Visual Scheduling Board" });
