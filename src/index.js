/** CoreCare Enterprise 1.15.6 — Rota Interaction Stabilisation */
...
export default {
  async fetch(request, env) {
    ...
    try {
      ...
      if (url.pathname === "/api/version") return json({ name: "CoreCare", version: VERSION, release: "CoreCare Enterprise 1.15.6 — Rota Interaction Stabilisation" });
