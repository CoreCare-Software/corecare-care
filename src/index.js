/** CoreCare Enterprise 1.18.0 — Planner Command Centre */
...
export default {
  async fetch(request, env) {
    ...
    try {
      ...
      if (url.pathname === "/api/version") return json({ name: "CoreCare", version: VERSION, release: "CoreCare Enterprise 1.18.0 — Planner Command Centre" });
