/** CoreCare Enterprise 1.16.2 — Rota Timeline Positioning Repair */
...
export default {
  async fetch(request, env) {
    ...
    try {
      ...
      if (url.pathname === "/api/version") return json({ name: "CoreCare", version: VERSION, release: "CoreCare Enterprise 1.16.2 — Rota Timeline Positioning Repair" });
