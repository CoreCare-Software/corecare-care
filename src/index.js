/** CoreCare Enterprise 1.24.2 — eMAR and Body Map */
...
export default {
  async fetch(request, env) {
    ...
    try {
      ...
      if (url.pathname === "/api/version") return json({ name: "CoreCare", version: VERSION, release: "CoreCare Enterprise 1.24.2 — eMAR and Body Map" });
